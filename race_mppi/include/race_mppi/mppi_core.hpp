#ifndef RACE_MPPI__MPPI_CORE_HPP_
#define RACE_MPPI__MPPI_CORE_HPP_
...
// linked into race_mppi.  Finding CUDA headers or the vendor package alone is
...
#endif  // RACE_MPPI__MPPI_CORE_HPP_
